...
SET Column_New='event_no'
WHERE Column_Old='msha_Inspect_event_no';

UPDATE Column_Rename
SET Column_New='mine_id'
WHERE Column_Old='msha_Inspect_mine_id';

UPDATE Column_Rename
SET Column_New='acty_cd'
WHERE Column_Old='msha_Inspect_acty_cd';

UPDATE Column_Rename
SET Column_New='acty_desc'
WHERE Column_Old='msha_Inspect_acty_desc';

UPDATE Column_Rename
SET Column_New='beg_dt'
WHERE Column_Old='msha_Inspect_beg_dt';

UPDATE Column_Rename
SET Column_New='end_dt'
WHERE Column_Old='msha_Inspect_end_dt';

UPDATE Column_Rename
SET Column_New='controller_id'
WHERE Column_Old='msha_Inspect_controller_id';



UPDATE Column_Rename
SET Column_New='controller_name'
WHERE Column_Old='msha_Inspect_controller_name';



UPDATE Column_Rename
SET Column_New='operator_id'
WHERE Column_Old='msha_Inspect_operator_id';

UPDATE Column_Rename
SET Column_New='operator_name'
WHERE Column_Old='msha_Inspect_operator_name';

UPDATE Column_Rename
SET Column_New='cal_yr'
WHERE Column_Old='msha_Inspect_cal_yr';

UPDATE Column_Rename
SET Column_New='cal_qtr'
WHERE Column_Old='msha_Inspect_cal_qtr';

UPDATE Column_Rename
SET Column_New='fiscal_yr'
WHERE Column_Old='msha_Inspect_fiscal_yr';

UPDATE Column_Rename
SET Column_New='fiscal_qtr'
WHERE Column_Old='msha_Inspect_fiscal_qtr';

UPDATE Column_Rename
SET Column_New='inspect_office_cd'
WHERE Column_Old='msha_Inspect_inspect_office_cd';

UPDATE Column_Rename
SET Column_New='active_sections'
WHERE Column_Old='msha_Inspect_active_sections';

UPDATE Column_Rename
SET Column_New='idle_sections'
WHERE Column_Old='msha_Inspect_idle_sections';

UPDATE Column_Rename
SET Column_New='shaft_slope_sink'
WHERE Column_Old='msha_Inspect_shaft_slope_sink';

UPDATE Column_Rename
SET Column_New='impound_constr'
WHERE Column_Old='msha_Inspect_impound_constr';

UPDATE Column_Rename
SET Column_New='bldg_constr_sites'
WHERE Column_Old='msha_Inspect_bldg_constr_sites';

UPDATE Column_Rename
SET Column_New='draglines'
WHERE Column_Old='msha_Inspect_draglines';

UPDATE Column_Rename
SET Column_New='unclassified_constr'
WHERE Column_Old='msha_Inspect_unclassified_constr';

UPDATE Column_Rename
SET Column_New='co_records'
WHERE Column_Old='msha_Inspect_co_records';

UPDATE Column_Rename
SET Column_New='surf_ug_mine'
WHERE Column_Old='msha_Inspect_surf_ug_mine';

UPDATE Column_Rename
SET Column_New='facility_mine'
WHERE Column_Old='msha_Inspect_surf_facility_mine';

UPDATE Column_Rename
SET Column_New='refuse_piles'
WHERE Column_Old='msha_Inspect_refuse_piles';

UPDATE Column_Rename
SET Column_New='explosive_storage'
WHERE Column_Old='msha_Inspect_explosive_storage';

UPDATE Column_Rename
SET Column_New='outby_areas'
WHERE Column_Old='msha_Inspect_outby_areas';

UPDATE Column_Rename
SET Column_New='major_constr'
WHERE Column_Old='msha_Inspect_major_constr';

UPDATE Column_Rename
SET Column_New='shafts_slopes'
WHERE Column_Old='msha_Inspect_shafts_slopes';

UPDATE Column_Rename
SET Column_New='impoundments'
WHERE Column_Old='msha_Inspect_impoundments';

UPDATE Column_Rename
SET Column_New='misc_area'
WHERE Column_Old='msha_Inspect_misc_area';

UPDATE Column_Rename
SET Column_New='program_area'
WHERE Column_Old='msha_Inspect_program_area';

UPDATE Column_Rename
SET Column_New='sample_cnt_air'
WHERE Column_Old='msha_Inspect_sample_cnt_air';

UPDATE Column_Rename
SET Column_New='sample_cnt_dustspot'
WHERE Column_Old='msha_Inspect_sample_cnt_dustspot';

UPDATE Column_Rename
SET Column_New='sample_cnt_dustsurvey'
WHERE Column_Old='msha_Inspect_sample_cnt_dustsurvey';

UPDATE Column_Rename
SET Column_New='sample_cnt_respdust'
WHERE Column_Old='msha_Inspect_sample_cnt_respdust';

UPDATE Column_Rename
SET Column_New='sample_cnt_noise'
WHERE Column_Old='msha_Inspect_sample_cnt_noise';

UPDATE Column_Rename
SET Column_New='sample_cnt_other'
WHERE Column_Old='msha_Inspect_sample_cnt_other';

UPDATE Column_Rename
SET Column_New='nbr_inspectors'
WHERE Column_Old='msha_Inspect_nbr_inspectors';

UPDATE Column_Rename
SET Column_New='total_on_site_hours'
WHERE Column_Old='msha_Inspect_total_on_site_hours';

UPDATE Column_Rename
SET Column_New='total_insp_hours'
WHERE Column_Old='msha_Inspect_total_insp_hours';

UPDATE Column_Rename
SET Column_New='coal_metal_ind'
WHERE Column_Old='msha_Inspect_coal_metal_ind';

UPDATE Column_Rename
SET Column_New='inspection_begin_year'
WHERE Column_Old='msha_Inspect_inspection_begin_year';

UPDATE Column_Rename
SET Column_New='inspection_end_year'
WHERE Column_Old='msha_Inspect_inspection_end_year';

UPDATE Column_Rename
SET Column_New='state_abbr'
WHERE Column_Old='msha_Inspect_state_abbr';

UPDATE Column_Rename
SET Column_New='sic_code_4_digit'
WHERE Column_Old='msha_Inspect_sic_code_4_digit';

UPDATE Column_Rename
SET Column_New='mine_type_cd'
WHERE Column_Old='msha_Inspect_mine_type_cd';

UPDATE Column_Rename
SET Column_New='curr_mine_nm'
WHERE Column_Old='msha_Inspect_curr_mine_nm';

UPDATE Column_Rename
SET Column_New='curr_stat_cd'
WHERE Column_Old='msha_Inspect_curr_stat_cd';

UPDATE Column_Rename
SET Column_New='curr_stat_dt'
WHERE Column_Old='msha_inspect_curr_stat_dt';

UPDATE Column_Rename
SET Column_New='sig_sub_y'
WHERE Column_Old='msha_Inspect_sig_sub_y';

UPDATE Column_Rename
SET Column_New='sig_sub_n'
WHERE Column_Old='msha_Inspect_sig_sub_n';
